...
public struct Colors {
    ...
    public static let background = Color(hexString: "#dbd4f8")
    public static let alternateBackground = Color(hexString: "#fe5000")
    public static let secondaryBackground = Color(hexString: "#314eeb")
    public static let alternameSecondaryBackground = Color(hexString: "#a3ff8c")
    public static let selectedTab = Color(hexString: "#000000")
}
